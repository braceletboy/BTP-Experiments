...
This file contains the decoder for the segmenation process.
...
class Decoder(nn.Module):
    '''
    The class for the decoder in deeplab v3 plus
    '''
    def __init__(self, num_classes, backbone, BatchNorm):
        ...
        @param backbone: The backbone used for the dataset.
        @param BatchNorm: The batch normalization layer to be used.
        '''
