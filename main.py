...
_TAG_MAP = {
    'BlockCCNN': BasicClassificationCNN,
...
def main(args, network_definition):
    ...
    if args.task == 'classification':
        model = _TAG_MAP[args.model_tag](network_definition).to(
            args.device)
        ...
        if args.task_number == 2:
            ...
            for param in model.conv_network.parameters():
                param.requires_grad = False
            for param in model.fc_network.parameters():
                param.requires_grad = False
